...
the user an easy way to exclude items they do not considered.
...
"Character Profiles" contains the names of Character Cards that possess at least a user specified given set of affiliations
		...
		V.i Support Output
			...
			An output entry will look like:
							...
							----------------------------------------------------------------------
									Ambush, level 2
									Battle Penalty Reduction, level 3
									Battle Reward Credit UP, level 1

								4*  Shadow Stormtrooper   5*  Jabba the Hutt   3*  Greedo

								9 (Droid,  Galactic Empire)  13 (Jabbas Crime Syndicate)  4 (Bounty Hunter,  Rebel Alliance)

									5*  Male,  Bounty Hunter,  Jabbas Crime Syndicate,  Mandalorian	(3 character cards with 1 awakened)
									5*  Droid,  Rebel Alliance	(2 character cards)
									4*  Droid,  Galactic Empire	(1 character cards)
									4*  Droid,  Galactic Empire	(1 character cards)


								17 (Male)  12 (Galactic Empire)  8 (Tatooinian)  13 (Jabbas Crime Syndicate)  8 (Bounty Hunter)  5 (Mandalorian)  13 (Droid)  5 (Rebel Alliance)

								Minimum cost: 142			Maximum Cost: 173
			...
			The second to last line is the total affiliation values using the above cards
			And the very last line is the cost range for this support deck
