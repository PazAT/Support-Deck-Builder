...
struct Card{
    ...
    int number_of_types, rarity, evo_level, affiliation_sum, is_awakened, card_ID, skill_ID, skillcard_ID;
    double cost, min_cost, max_cost;
    char name[MAXNAME], skillname[MAXNAME];
    bool has_skill;
...
struct SupportSkill{
    ...
    char skillName[MAXNAME], skillNickname[MAXNAME];
...
struct SupportDeck{
    ...
    char skills_in_deck[SUPPORTDECK][MAXNAME];
